...
TEST_METADATA_PATH: Path | None = Path("./input/birdclef-2025/sample_submission.csv") # TODO: Update or set to None!

# NOTE: Path to the TRAINED model checkpoint (from fine-tuning)
MODEL_CHECKPOINT_PATH: Path = Path("./output/checkpoints/best_model_step_XYZ.pt") # TODO: Update with actual best checkpoint!
...
try:
    ...
    print("[ERROR] Could not import fine_tune/config.py. Define test config values manually.")
