...
CHUNK_DURATION_SEC: float = (
    5.0  # Use same chunk size as fine-tuning? Or maybe longer? Let's stick to 5s.
)
...
MASKING_RATIO: float = (
    0.75  # Proportion of time frames to mask (high ratio is common for MAE)
)
# MAE Decoder configuration
DECODER_EMBED_DIM: int = (
    512  # Dimension for the decoder layers (can be smaller than encoder)
)
...
CHECKPOINT_INTERVAL_STEPS: int = (
    1000  # How often to save full MAE model checkpoint (optional)
)
