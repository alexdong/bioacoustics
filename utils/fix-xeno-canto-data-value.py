    ...
    for filename in os.listdir(folder_path):
        if filename.lower().endswith(".json"):
            ...
            try:
                ...
                if "date" in data:
                    ...
                    try:
                        ...
                        if isinstance(current_date_value, str):
                            ...
                            print(
                                f"Found non-string date value in {filename}: '{invalid_date_value}'. Updating...",
                            )
                            needs_update = True
                        ...
                        invalid_date_value = current_date_value
                        print(
                            f"Found invalid/unparseable date format in {filename}: '{invalid_date_value}'. Updating...",
                        )
                        needs_update = True
                ...
                if "time" in data:
                    ...
                    try:
                        ...
                        if isinstance(current_time_value, str):
                            ...
                            print(
                                f"Found non-string time value in {filename}: '{invalid_time_value}'. Updating...",
                            )
                            needs_update = True
                        ...
                        invalid_time_value = current_time_value
                        print(
                            f"Found invalid/unparseable time format in {filename}: '{invalid_time_value}'. Updating...",
                        )
                        needs_update = True
                        data["time"] = DEFAULT_TIME_STR  # Set default time
                else:
                ...
                error_msg = (
                    f"Error decoding JSON in file: {filename}. Skipping this file."
                )
                print(error_msg)
                errors.append(error_msg)
            except IOError as e:
                error_msg = (
                    f"Error reading/writing file {filename}: {e}. Skipping this file."
                )
                print(error_msg)
                errors.append(error_msg)
